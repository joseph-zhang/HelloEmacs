...
;; 2) if the installation of spacemacs meet an 'mispell' error, try emacs with -inscure;
;; 3) if some package are not installed correctly, just delete them in elpa, and rebbot the emacs;
;; 4) to change the modeline separator effect, use
